...
<?php $attributes = array('class' => 'form-horizontal'); echo form_open(uri_string());?>

      <div class="form-group row">
			<label for="domain" class="col-2 col-form-label">Domain Name</label>
			<div class="col-5">
			<?php echo form_input($user_id);?>
            <?php echo form_input($domain);?>
			</div>
      </div>
	  <?php $extra_button = 'class="btn btn-lg btn-primary"'; echo form_submit('submit', 'Create API Key', $extra_button);?>
